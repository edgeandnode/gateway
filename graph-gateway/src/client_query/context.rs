...
use gateway_framework::{
    ...
    reporting::KafkaClient, scalar::ReceiptSigner, topology::network::GraphNetwork,
};
use ordered_float::NotNan;
use url::Url;

use crate::{gateway::SubgraphIndexingStatus, indexer_client::IndexerClient};
...
pub struct GatewayState {
    ...
    pub indexing_statuses: Eventual<Ptr<HashMap<Indexing, SubgraphIndexingStatus>>>,
