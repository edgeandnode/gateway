...
mod tests {
    ...
    mod legacy {
        ...
        fn create_receipt() {
            ...
            let largest_allocation =
                parse_allocation_id("0x89b23fea4e46d40e8a4c6cca723e2a03fdd4bec2");
            let fee = 1000;
    ...
    mod tap {
        ...
        fn create_receipt() {
            ...
            let allocation = parse_allocation_id("0x89b23fea4e46d40e8a4c6cca723e2a03fdd4bec2");
            let fee = 1000;
    ...
    fn create_legacy_receipt() {
        ...
        let signer = ReceiptSigner::new(
            tap_secret_key,
            1.try_into().expect("invalid chain id"),
            parse_allocation_id("0x177b557b12f22bb17a9d73dcc994d978dd6f5f89").into_inner(),
            legacy_secret_key,
        );

        let largest_allocation = parse_allocation_id("0x89b23fea4e46d40e8a4c6cca723e2a03fdd4bec2");
        let fee = 1000;
